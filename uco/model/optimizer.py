...
class Ranger(Optimizer):
    ...
    def __init__(self, params, lr=1e-3, alpha=0.5, k=6, N_sma_threshhold=5, betas=(.95, 0.999),
        ...
        # In both cases, worth testing on your dataset (.90 vs .95, 4 vs 5)
        # to make sure which works best for you.
        ...
        # This should resolve issues with load/save where weights were left in GPU memory from
        # first load, slowing down future runs.
